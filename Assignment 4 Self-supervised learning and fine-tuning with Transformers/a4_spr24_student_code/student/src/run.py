...
def main():
    ...
    if args.function == 'pretrain':
        ...
        # 设置训练配置
        config = trainer.TrainerConfig(
            max_epochs=75 if args.reading_params_path is None else 10,  # 根据是否有预训练模型选择epochs
            batch_size=256,
            learning_rate=args.finetune_lr,
            lr_decay=True,
            warmup_tokens=512*20,
        ...
        if args.reading_params_path:
            print("Loading pretrained parameters from", args.reading_params_path)
